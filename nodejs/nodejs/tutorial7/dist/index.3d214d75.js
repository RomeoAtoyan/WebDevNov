...
_axiosDefault.default("https://jsonplaceholder.typicode.com/posts").then((res)=>res.data
).then((data)=>{
    console.log(data);
    data.forEach((post)=>{
        console.log(post.title);
        _jqueryDefault.default('.list-group').append(`<li class="list-group-item">${post.title}</li>`);
    });
});
console.log(_jqueryDefault.default(".list-group"));

},{"axios":"jo6P5","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["iKiqL","bB7Pu"], "bB7Pu", "parcelRequireed48")
